...
def get_E_E_PV_h(E_E_srpl, E_E_PV_max_sup, E_E_dmd_incl, SC):
...
def get_E_E_PV_sell(E_E_srpl, E_E_PV_chg, SC):
...
def get_E_E_PV_chg(E_E_srpl, E_E_SB_max_chg, SC):
...
def get_E_E_PSS_h(E_E_srpl, E_E_dmd_incl, E_E_PSS_max_sup, E_E_PV_h, SC):
...
def get_E_E_PSS_max_sup(E_E_PV_max_sup, E_E_SB_max_sup):
...
def get_E_E_srpl(E_E_PV_max_sup, E_E_dmd_incl):
    """ 1 時間当たりの余剰電力量 (kWh/h)
...
def get_E_E_dmd_incl(E_E_dmd_excl, E_E_aux_PSS):
...
def get_E_E_aux_PSS(E_E_aux_PCS, E_E_aux_others):
...
def get_E_dash_dash_E_srpl(E_E_srpl, E_dash_dash_E_in_rtd_PVtoDB, alpha_PVtoDB, beta_PVtoDB):
...
def get_E_dash_dash_E_SB_sup(E_E_SB_sup, E_dash_dash_E_in_rtd_SBtoDB, alpha_SBtoDB, beta_SBtoDB):
...
def get_E_E_PV_max_sup(E_dash_dash_E_PV_max_sup, E_dash_dash_E_in_rtd_PVtoDB, alpha_PVtoDB, beta_PVtoDB, eta_ce_lim_PVtoDB):
...
def get_E_E_SB_max_sup(E_dash_dash_E_SB_max_sup, E_dash_dash_E_in_rtd_SBtoDB, alpha_SBtoDB, beta_SBtoDB, eta_ce_lim_SBtoDB):
...
def get_E_dash_dash_E_PV_max_sup(E_dash_dash_E_PV_gen):
...
def get_E_dash_dash_E_SB_max_sup(E_dash_dash_E_SB_max_dchg):
...
def get_E_E_SB_max_chg(E_dash_dash_E_SB_max_chg, E_E_srpl, E_dash_dash_E_srpl, E_dash_dash_E_in_rtd_PVtoSB, alpha_PVtoSB, beta_PVtoSB, eta_ce_lim_PVtoSB):
...
def f_E_out_PVtoDB(x_E_in, E_dash_dash_E_in_rtd_PVtoDB, alpha_PVtoDB, beta_PVtoDB, eta_ce_lim_PVtoDB):
...
def get_eta_ce_PVtoDB(x_E_in, E_dash_dash_E_in_rtd_PVtoDB, alpha_PVtoDB, beta_PVtoDB, eta_ce_lim_PVtoDB):
...
def f_E_dash_dash_in_PVtoDB(x_E_out, E_dash_dash_E_in_rtd_PVtoDB, alpha_PVtoDB, beta_PVtoDB):
...
def f_E_dash_dash_out_PVtoSB(x_E_in, E_dash_dash_E_in_rtd_PVtoSB, alpha_PVtoSB, beta_PVtoSB, eta_ce_lim_PVtoSB):
...
def get_eta_ce_PVtoSB(x_E_in, E_dash_dash_E_in_rtd_PVtoSB, alpha_PVtoSB, beta_PVtoSB, eta_ce_lim_PVtoSB):
...
def f_E_dash_dash_in_PVtoSB(x_E_out, E_dash_dash_E_in_rtd_PVtoSB, alpha_PVtoSB, beta_PVtoSB):
...
def f_E_out_SBtoDB(x_E_in, E_dash_dash_E_in_rtd_SBtoDB, alpha_SBtoDB, beta_SBtoDB, eta_ce_lim_SBtoDB):
...
def get_eta_ce_SBtoDB(x_E_in, E_dash_dash_E_in_rtd_SBtoDB, alpha_SBtoDB, beta_SBtoDB, eta_ce_lim_SBtoDB):
...
def f_E_dash_dash_in_SBtoDB(x_E_out, E_dash_dash_E_in_rtd_SBtoDB, alpha_SBtoDB, beta_SBtoDB):
...
def f_eta_ec(x_E_in, x_E_in_rtd, x_a, x_b, x_eta_ce_lim):
    """合成変換効率を求める関数
...
def f_E_in(x_E_out, x_E_in_rtd, x_a, x_b):
    """入力電力量を出力電力量から逆算する関数
    ...
    return max(min((-x_a * x_E_in_rtd + x_E_out) / x_b, x_E_in_rtd), x_E_in_rtd * 0.25)


# 8.7 補機の消費電力量


def get_E_E_aux_PCS(P_aux_PCS_oprt, tau_oprt_PSS, P_aux_PCS_stby):
...
def get_E_dash_dash_E_SB_max_chg(I_max_chg, V_max_chg, delta_tau_max_chg):
...
def get_V_max_chg(SOC_st0, SOC_star_max, T_amb_bmdl, type_batt, I_max_chg, R_intr):
    ...
    OCV = f_OCV(SOC_st0, SOC_star_max, T_amb_bmdl, type_batt)
...
def get_I_max_chg(C_oprt_chg, delta_tau_max_chg):
    """充電に対する蓄電池の電流 (A)
...
def get_E_dash_dash_E_SB_max_dchg(I_max_dchg, V_max_dchg, delta_tau_max_dchg):
...
def get_V_max_dchg(SOC_st0, SOC_star_min, T_amb_bmdl, type_batt, I_max_dchg, R_intr):
    ...
    OCV = f_OCV(SOC_st0, SOC_star_min, T_amb_bmdl, type_batt)
...
def get_I_max_dchg(C_oprt_dchg, delta_tau_max_dchg):
...
def get_delta_tau_max_dchg_d_t():
...
def get_E_dash_dash_E_SB_chg(E_dash_dash_E_PV_chg):
...
def get_E_dash_dash_E_SB_dchg(E_dash_dash_E_SB_sup):
...
def get_C_oprt_chg(C_fc, SOC_star_max, SOC_star_min, C_oprt_dchg):
    """蓄電池の充電可能容量 (Ah)
...
def get_C_oprt_dchg_0(C_fc, SOC_star_max, SOC_star_min, r_int_dchg_batt):
...
def get_C_oprt_dchg(C_fc, SOC_st1_previoushour, SOC_star_min):
    """蓄電池の放電可能容量 (Ah)
...
def get_SOC_st0(SOC_star_min, C_oprt_dchg, C_fc):
...
def get_SOC_st1(SOC_st0, SOC_star_max, SOC_star_min, I_chg, I_dchg, delta_tau_chg, delta_tau_dchg, C_fc, E_dash_dash_E_SB_chg, E_dash_dash_E_SB_dchg):
...
def get_I_chg(E_dash_dash_E_SB_chg, E_dash_dash_E_SB_dchg, V_OC, R_intr):
    """充電に対する蓄電池の電流 (A)
...
def get_I_dchg(E_dash_dash_E_SB_chg, E_dash_dash_E_SB_dchg, V_OC, R_intr):
    """放電に対する蓄電池の電流 (A)
...
def get_V_OC(SOC_st0, SOC_hat_st1, E_dash_dash_E_SB_chg, E_dash_dash_E_SB_dchg, T_amb_bmdl, type_batt):
    """蓄電池の閉回路電圧 (V)
    ...
    if E_dash_dash_E_SB_chg > 0 or E_dash_dash_E_SB_dchg > 0:
        ...
        return f_OCV(SOC_hat_st0, SOC_hat_st1, T_amb_bmdl, type_batt)
    else:
        return 0.0


def get_SOC_hat_st0(SOC_st_0):
...
def get_SOC_hat_st1(SOC_st0, C_fc, delta_t_chg, delta_t_dchg, V_rtd_batt, E_dash_dash_E_SB_chg, E_dash_dash_E_SB_dchg):
...
def get_R_intr(T_amb_bmdl, type_batt):
    """蓄電池の内部抵抗 (Ω)
...
def get_delta_tau_chg(E_dash_dash_E_SB_chg, E_dash_dash_E_SB_dchg):
    """蓄電池ユニットの充電時間 (h)
...
def get_delta_tau_dchg(E_dash_dash_E_SB_chg, E_dash_dash_E_SB_dchg):
    """蓄電池ユニットの放電時間 (h)
...
def get_SOC_star_max(SOC_star_upper):
    """蓄電池ユニットが充電を停止する充電率 (-)
...
def get_SOC_star_min(SOC_star_lower, SOC_star_upper, r_LCP_batt, SC):
    """蓄電池ユニットが放電を停止する充電率 (-)
    ...
    if SC:
        # 系統連携運転時の場合 式(44-1)
        return SOC_star_lower + r_LCP_batt * (SOC_star_lower - SOC_star_upper)
    else:
        # 独立運転時の場合 式(44-2)
        return SOC_star_lower


def get_SOC_star_upper(V_star_upper_batt, T_amb_bmdl, type_batt):
    """蓄電池の上限電圧に対応する充電率 (-)
    ...
    """
    # f = lambda x: f_V_lim(x, T_amb_bmdl, type_batt) - V_star_upper_batt
    # return bisect(f, 0.01, 0.99)
    return 0.8


def get_SOC_star_lower(V_star_lower_batt, T_amb_bmdl, type_batt):
    """蓄電池の下限電圧に対応する充電率 (-)
    ...
    """
    # f = lambda x: f_V_lim(x, T_amb_bmdl, type_batt) - V_star_lower_batt
    # return bisect(f, 0.01, 0.99)
    return 0.2


def get_C_fc_d_t(C_fc_rtd):
...
def get_C_fc_rtd(W_rtd_batt, V_rtd_batt):
    """蓄電池の初期満充電容量 (Ah)
...
# 9.8 開回路電圧・上限電圧・下限電圧を表す関数


def f_OCV(x_SOC_alpha, x_SOC_beta, x_T_amb, x_type):
    """充放電により蓄電池の状態が状態𝛼から状態𝛽に変化する場合の開回路電圧の絶対値の関数定義 式(50a)

    Args:
        x_SOC_alpha (float): 蓄電池が状態αにある場合の蓄電池の充電率 (-)
        x_SOC_beta (float): 蓄電池が状態βにある場合の蓄電池の充電率 (-)
    ...
    """
    x_SOC_l = get_x_SOC_l(x_SOC_alpha, x_SOC_beta)
    x_SOC_h = get_x_SOC_h(x_SOC_alpha, x_SOC_beta)
    ...
    f_tilde_i = (
        f_tilde_0(x_T_amb, x_type, x_SOC_h, x_SOC_l),
        f_tilde_1(x_T_amb, x_type, x_SOC_h, x_SOC_l),
        f_tilde_2(x_T_amb, x_type, x_SOC_h, x_SOC_l),
        f_tilde_3(x_T_amb, x_type, x_SOC_h, x_SOC_l),
        f_tilde_4(x_T_amb, x_type, x_SOC_h, x_SOC_l)
    )
    OCV = sum(f_tilde_i)

    #TODO: OCVが負の値を取ることは無いでしょうか？安全範囲は？
    if OCV < 0:
        raise ValueError('OCV < 0')

    return OCV


def f_tilde_0(x_T_amb, x_type, x_SOC_h, x_SOC_l):
    """閉回路電圧の絶対値を表す関数f_OCVのK_0に対応した項を求める関数

    Args:
        x_T_amb (float): 関数の引数 (蓄電池モジュールの周囲温度) (K)
        x_type (type): 関数の引数 (蓄電池の種類) (-)
        x_SOC_h (float): 関数の引数 (x_SOC_alphaとx_SOC_betaのうち値が大きい蓄電池の充電率) (-)
        x_SOC_l (float): 関数の引数 (x_SOC_alphaとx_SOC_betaのうち値が小さい蓄電池の充電率) (-)
    
    Returns:
        float: 閉回路電圧の絶対値を表す関数f_OCVのK_0に対応した項 (V)
    """
    K_0 = get_K_0(x_T_amb, x_type)
    return K_0 * (x_SOC_h - x_SOC_l)


def f_tilde_1(x_T_amb, x_type, x_SOC_h, x_SOC_l):
    """閉回路電圧の絶対値を表す関数f_OCVのK_1に対応した項を求める関数
    ...
    Returns:
        float: 閉回路電圧の絶対値を表す関数f_OCVのK_1に対応した項 (V)
    """
    K_1 = get_K_1(x_T_amb, x_type)
    return - K_1 * (math.log(x_SOC_h) - math.log(x_SOC_l))


def f_tilde_2(x_T_amb, x_type, x_SOC_h, x_SOC_l):
    """閉回路電圧の絶対値を表す関数f_OCVのK_2に対応した項を求める関数
    ...
    Returns:
        float: 閉回路電圧の絶対値を表す関数f_OCVのK_2に対応した項 (V)
    """
    K_2 = get_K_2(x_T_amb, x_type)
    return - (1/2) *  K_2 * (x_SOC_h**2 - x_SOC_l**2)


def f_tilde_3(x_T_amb, x_type, x_SOC_h, x_SOC_l):
    """閉回路電圧の絶対値を表す関数f_OCVのK_3に対応した項を求める関数
    ...
    Returns:
        float: 閉回路電圧の絶対値を表す関数f_OCVのK_3に対応した項 (V)
    """
    K_3 = get_K_3(x_T_amb, x_type)
    return K_3 * (x_SOC_h * (math.log(x_SOC_h) - 1) - x_SOC_l * (math.log(x_SOC_l) - 1))


def f_tilde_4(x_T_amb, x_type, x_SOC_h, x_SOC_l):
    """閉回路電圧の絶対値を表す関数f_OCVのK_4に対応した項を求める関数
    ...
    Returns:
        float: 閉回路電圧の絶対値を表す関数f_OCVのK_4に対応した項 (V)
    """
    K_4 = get_K_4(x_T_amb, x_type)
    return - K_4 * ((1 - x_SOC_h) * (math.log(1 - x_SOC_h) - 1) - (1 - x_SOC_l) * (math.log(1 - x_SOC_l) - 1))


def get_x_SOC_l(x_SOC_alpha, x_SOC_beta):
    """関数の引数 (x_SOC_alphaとx_SOC_betaのうち値が小さい蓄電池の充電率)

    Args:
        x_SOC_alpha (float): 関数の引数 (蓄電池が状態αにある場合の蓄電池の充電率)
        x_SOC_beta (float): 関数の引数 (蓄電池が状態βにある場合の蓄電池の充電率)

    Returns:
        float: 関数の引数 (x_SOC_alphaとx_SOC_betaのうち値が小さい蓄電池の充電率)
    """
    x_SOC_l = min(x_SOC_alpha, x_SOC_beta)
    return x_SOC_l


def get_x_SOC_h(x_SOC_alpha, x_SOC_beta):
    """関数の引数 (x_SOC_alphaとx_SOC_betaのうち値が大きい蓄電池の充電率)
    ...
    Returns:
        float: 関数の引数 (x_SOC_alphaとx_SOC_betaのうち値が大きい蓄電池の充電率)
    """
    x_SOC_h = max(x_SOC_alpha, x_SOC_beta)
    return x_SOC_h


def f_V_lim(x_SOC_lim, x_T_amb, x_type):
    """上限電圧および下限電圧を表す関数

    Argss:
        x_SOC_lim (float): 関数の引数 (蓄電池の上限電圧または下限電圧に対応する蓄電池の充電率) (-)
        x_T_amb (float): 関数の引数 (蓄電池モジュールの周囲温度) (K)
        x_type (type): 関数の引数 (蓄電池の種類) (-)
    ...
    V_lim = K_0 \
        - K_1 / x_SOC_lim \
        - K_2 * x_SOC_lim \
        + K_3 * math.log(x_SOC_lim) \
        + K_4 * math.log(1 - x_SOC_lim)
    return V_lim


def get_K_0(x_T_amb, x_type):
...
def get_V_star_lower_batt(spec):
    """蓄電池の下限電圧 (V)
...
def get_V_star_upper_batt(spec):
    """蓄電池の上限電圧 (V)
...
def get_type_batt(V_star_upper_batt, V_star_lower_batt):
    """蓄電池の種類 (-)
...
def get_T_amb_bmdl_d_t(theta_ex_d_t):
...
def get_E_E_aux_others(P_aux_others_oprt, tau_oprt_PSS, P_aux_others_stby):
...
def get_tau_oprt_PSS(E_dash_dash_E_PV_gen, E_E_dmd_excl, E_dash_dash_E_SB_max_dchg):
    """ 1時間当たりの蓄電設備の作動時間数
...
def get_E_dash_dash_E_PV_gen_d_t(n, E_p_i_d_t, K_PM_i, K_IN):
...
def calculate(spec, df):
    ...
    Returns:
        array: 出力値(E_E_PV_chg_d_t, E_E_PSS_h_d_t, E_E_PV_h_d_t, E_E_PV_sell_d_t)
    """
    # 出力変数の準備
    # (1)
    ...
    for dt, (SC, E_E_dmd_excl, E_dash_dash_E_PV_gen, T_amb_bmdl, C_fc, delta_tau_max_chg, delta_t_max_dchg) in enumerate(zip(SC_d_t, E_E_dmd_excl_d_t, E_dash_dash_E_PV_gen_d_t, T_amb_bmdl_d_t, C_fc_d_t, delta_tau_max_chg_d_t, delta_tau_max_dchg_d_t)):
        ...
        # 蓄電池の上限電圧に対応する充電率 式(45)
        SOC_star_upper = get_SOC_star_upper(V_star_upper_batt, T_amb_bmdl, type_batt)

        # 蓄電池の下限電圧に対応する充電率 式(46)
        SOC_star_lower = get_SOC_star_lower(V_star_lower_batt, T_amb_bmdl, type_batt)
        ...
        # 蓄電池ユニットが最大充電可能電力量を充電する時の電圧 式(27)
        V_max_chg = get_V_max_chg(SOC_st0, SOC_star_max, T_amb_bmdl, type_batt, I_max_chg, R_intr)
        ...
        # 蓄電池ユニットが最大放電可能電力量を放電する時の電圧 式(30)
        V_max_dchg = get_V_max_dchg(SOC_st0, SOC_star_min, T_amb_bmdl, type_batt, I_max_dchg, R_intr)
        ...
        # 蓄電池の開回路電圧 式(39a)
        V_OC = get_V_OC(SOC_st0, SOC_hat_st1, E_dash_dash_E_SB_chg, E_dash_dash_E_SB_dchg, T_amb_bmdl, type_batt)
